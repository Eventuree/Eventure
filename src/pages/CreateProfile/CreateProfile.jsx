...
export default function CreateProfile() {
  ...
  useEffect(() => {
    console.log("Отримано дані з Register:", registrationData);
    if (!registrationData) {
      navigate("/register");
    }
  }, [registrationData]);
            ...
            <div className={styles.selectorsContainer}>
              <div className={styles.citySelector}>
                ...
                <select
                  ...
                  required
                  className={`${styles.citySelect} ${styles.selectField}`}
                  onChange={handleChange}
                >
                  <option value="" disabled hidden>
                    Оберіть*
                  </option>
                  <option value="kyiv" className={styles.selectOption}>
                    Київ
                  </option>
                  <option value="lviv" className={styles.selectOption}>
                    Львів
                  </option>
                </select>
              </div>
        ...
        >
          ...
          <div className={styles.socials}>
            ...
            <input
              type="url"
              id="socials"
              placeholder="Посилання на соц. мережі"
              onChange={handleChange}
              required
