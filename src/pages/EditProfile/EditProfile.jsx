  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:8080/api/v1/profiles/${userId}`,
        {
          method: "PUT",
          headers: {
        ...
        <section className={styles.profileInfo}>
          <div className={styles.editPic}>
            <div className={styles.picContainer}>
              <img
                src={previewUrl || `/assets/icons/user.png`}
                alt="Preview"
                className={previewUrl ? styles.userPic : styles.avatarPreview}
              />
            </div>
              ...
              <div className={`${styles.cityGender} ${styles.container}`}>
                ...
                <label htmlFor="gender" className={styles.label}>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className={`${styles.select} ${styles.selectField}`}
                  >
